...
public class FrmManagerModifyPwd extends JDialog implements ActionListener {
	...
	public FrmManagerModifyPwd(Frame f, String s, boolean b) {
		super(f, s, b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btnCancel)
			...
			try {
				TakeOutUtil.managerManager.changePwd(BeanManager.currentLoginUser,new String(edtPwdOld.getPassword()),new String(edtPwd.getPassword()),new String(edtPwd2.getPassword()));
				this.setVisible(false);
